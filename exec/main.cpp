...
//	std::vector<std::list<int>> tree = PruferToAdjacencyMatrix(prufer);
...
//	std::list<int> vec1 = {3};
//	std::list<int> vec2 = {3};
//	std::list<int> vec3 = {0,1,2,4};
//	std::list<int> vec4 = {3,5};
//	std::list<int> vec5 = {4};
//
//	std::vector<std::list<int>> adjacency_list = {vec0, vec1, vec2, vec3, vec4, vec5};
//
